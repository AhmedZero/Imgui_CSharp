...
namespace Mochi.DearImGui
{
    ...
    public unsafe partial struct ImGuiPlatformIO
    {
        ...
        [FieldOffset(24)] public delegate* unmanaged[Cdecl]<ImGuiViewport*, Vector2, void> Platform_SetWindowPos;

        [FieldOffset(32)] public delegate* unmanaged[Cdecl]<Vector2*, ImGuiViewport*, Vector2*> Platform_GetWindowPos;

        [FieldOffset(40)] public delegate* unmanaged[Cdecl]<ImGuiViewport*, Vector2, void> Platform_SetWindowSize;

        [FieldOffset(48)] public delegate* unmanaged[Cdecl]<Vector2*, ImGuiViewport*, Vector2*> Platform_GetWindowSize;
        ...
        [FieldOffset(136)] public delegate* unmanaged[Cdecl]<ImGuiViewport*, ulong, void*, ulong*, int> Platform_CreateVkSurface;

        [FieldOffset(144)] public delegate* unmanaged[Cdecl]<ImGuiViewport*, void> Renderer_CreateWindow;

        [FieldOffset(152)] public delegate* unmanaged[Cdecl]<ImGuiViewport*, void> Renderer_DestroyWindow;

        [FieldOffset(160)] public delegate* unmanaged[Cdecl]<ImGuiViewport*, Vector2, void> Renderer_SetWindowSize;

        [FieldOffset(168)] public delegate* unmanaged[Cdecl]<ImGuiViewport*, void*, void> Renderer_RenderWindow;

        [FieldOffset(176)] public delegate* unmanaged[Cdecl]<ImGuiViewport*, void*, void> Renderer_SwapBuffers;

        [FieldOffset(184)] public ImVector<ImGuiPlatformMonitor> Monitors;

        [FieldOffset(200)] public ImVector<Pointer<ImGuiViewport>> Viewports;

        [DllImport("Mochi.DearImGui.Native", CallingConvention = CallingConvention.Cdecl, EntryPoint = "__InlineHelper21", ExactSpelling = true)]
