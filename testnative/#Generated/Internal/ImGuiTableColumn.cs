...
namespace Mochi.DearImGui.Internal
{
    ...
    public unsafe partial struct ImGuiTableColumn
    {
        ...
        [FieldOffset(91)] [MarshalAs(UnmanagedType.I1)] public bool IsUserEnabled;

        [FieldOffset(92)] [MarshalAs(UnmanagedType.I1)] public bool IsUserEnabledNextFrame;

        [FieldOffset(93)] [MarshalAs(UnmanagedType.I1)] public bool IsVisibleX;

        [FieldOffset(94)] [MarshalAs(UnmanagedType.I1)] public bool IsVisibleY;

        [FieldOffset(95)] [MarshalAs(UnmanagedType.I1)] public bool IsRequestOutput;

        [FieldOffset(96)] [MarshalAs(UnmanagedType.I1)] public bool IsSkipItems;

        [FieldOffset(97)] [MarshalAs(UnmanagedType.I1)] public bool IsPreserveWidthAuto;

        [FieldOffset(98)] public sbyte NavLayerCurrent;

        [FieldOffset(99)] public byte AutoFitQueue;

        [FieldOffset(100)] public byte CannotSkipItemsQueue;

        [FieldOffset(101)] private byte __SortDirection__backingField;
        ...
        [FieldOffset(101)] private byte __SortDirectionsAvailCount__backingField;
        ...
        [FieldOffset(101)] private byte __SortDirectionsAvailMask__backingField;
        ...
        [FieldOffset(102)] public byte SortDirectionsAvailList;

        [DllImport("Mochi.DearImGui.Native", CallingConvention = CallingConvention.Cdecl, EntryPoint = "__InlineHelper57", ExactSpelling = true)]
